var form_id_js = "contact-newsletter";
...
var sendButton = document.getElementById("contact-subscribe");
...
function js_send() {
    ...
    data_js['text'] = `New email newsletter subscription from ${contactEmail}.
