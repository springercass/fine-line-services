...
var sendButton = document.getElementById("about-subscribe");
...
function js_send() {
    ...
    var aboutEmail = document.getElementById("about-email").value;
    
	data_js['subject'] = `New Newsletter Subscriber`;
    data_js['text'] = `New email newsletter subscription from ${aboutEmail}.
